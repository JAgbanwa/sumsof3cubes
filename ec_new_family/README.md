...
$$E_n : y^2 = X^3 + a_4(n)\,X + a_6(n)$$

where

$$a_4(n) = -45349632\, n^4 + 419904\, n^3$$

$$a_6(n) = 3\!\left(39182082048\, n^6 - 544195584\, n^5 + 1259712\, n^4 - 19\, n\right)$$
...
$$a_6(n) = 3n\!\left(39182082048\, n^5 - 544195584\, n^4 + 1259712\, n^3 - 19\right)$$
